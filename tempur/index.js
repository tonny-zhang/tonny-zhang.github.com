$(function(){
	...
	// 得到总数
	$.getJSON('http://10.14.85.116/tonny-zhang.github.com/tempur/php/counter.php',function(num){
	...
	function runYao(){
	    ...
	    var awards = ['images/award_1.png','images/award_2.png','images/award_3.png','images/award_4.png'];
	    var $img_num = $('#img_num');
	    ...
	    function getAwards(isBig){
			...
			$('#btn_share').click(function(){
				share(location.href,'我正参加摇一摇活动，我获得了','images/award_0.png');
			});
	    }
